...
public class SnsTopicExtension extends HttpStubExtension implements BeforeAllCallback, BeforeEachCallback, AfterEachCallback {
    ...
    private void subscribeToTopic(String topicArn) {
        snsClient.subscribe(topicArn, "http", format("http://subscriber.internal:{0,number,#}/subscriber", getHttpPort()));
    }
